	...
	public User() {
	   ...
	   public User(String userId, String userPwd,String userName, int age,char gender) {
		   /*
		      ...
		      this.userName = userName;
		   */
		   this(userId,userPwd,userName); // this 생성자=> 이렇게 하면코드를 더 간결하게 쓸수있음
		   /*
		    * 위의 같이 중복되는 동일한 초기화하는 내용의 생성자가 이미 존재할 경우
		    * this() 생성자 활용 가능
		    * => 같은 클래스 내에 생성자에서 또 다른 생성자 호출하고자 할때 사용함
		    * ** 유의 사항 : 반드시 첫줄에 작성해야됨!! 위치가 맨위여야함
		    */
		   this.age= age;
		   this.gender = gender;
	   }
